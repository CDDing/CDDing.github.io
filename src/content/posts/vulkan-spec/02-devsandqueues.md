---
title: "Devices and Queues (디바이스와 큐)"
date: 2026-02-22T14:02+09:00
tags:
  - vulkan/spec
summary: "VkInstance 생성 후 구현체와 상호작용하는 핵심 오브젝트인 디바이스와 큐를 다룬다."
order: 2
---
...
VkPhysicalDevice는 VkInstance로부터 열거되는 **디스패처블 핸들**이다. 인스턴스가 파괴되면 함께 무효화된다.
...
`VkBool32` 희소 리소스는 메모리를 부분적으로 바인딩할 수 있는 기능이다. 이 속성들은 희소 이미지의 타일 레이아웃과 비상주 접근 동작을 정의한다.
