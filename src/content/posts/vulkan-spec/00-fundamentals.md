---
title: "Fundamentals (기초)"
date: 2026-02-22T14:00+09:00
tags:
  - vulkan/spec
summary: "Vulkan의 핵심 아키텍처와 실행 모델, API 문법, 큐, 파이프라인 구성, 수치 표현, 오브젝트 수명."
order: 0
---
...
- 각 디바이스는 하나 이상의 **큐(Queue)** 를 가짐 → 비동기 처리 가능
...
| Allocate/Free | `vkAllocate*` | `vkFree*` | 풀에서 할당. 고빈도 할당/해제에 적합 |
